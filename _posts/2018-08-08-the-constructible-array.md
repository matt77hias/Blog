...
Note that the template class can use a C-style array or `std::array< T >` (possibly encapsulating the latter's member methods using proxy member methods as well).
